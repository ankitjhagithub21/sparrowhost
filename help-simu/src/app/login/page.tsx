                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative border border-gray-300 rounded-lg">
                                    ...
                                    <Input
                                        ...
                                        className="pl-10 bg-white/10  border-white/20 placeholder:text-gray-400 focus:border-purple-400"
                                    />
                                </div>
                                {errors.email && (
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative border border-gray-300 rounded-lg">
                                    ...
                                    <Input
                                        ...
                                        className="pl-10 pr-12 bg-white/10 border-white/20  placeholder:text-gray-400 focus:border-purple-400"
                                        required
                                    />
